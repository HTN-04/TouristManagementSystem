...
//        return validDangNhap;
    ...
    //code mới
    // Phương thức lấy MaKDL từ cơ sở dữ liệu dựa trên tên đăng nhập
public int getMaKDL(String tenDangNhap) {
    int maKDL = -1;
    String sql = "SELECT MaKDL FROM KHACH_DU_LICH WHERE TenDangNhap = ?";
